...
CREATE TABLE `gradesubject` (
  ...
  `idGrade` int unsigned NOT NULL,
  `idSubject` int unsigned NOT NULL,
  PRIMARY KEY (`idGradeSubject`),
  KEY `idGrade_idx` (`idGrade`),
  KEY `idSubject_idx` (`idSubject`),
  CONSTRAINT `idGradeGS` FOREIGN KEY (`idGrade`) REFERENCES `grade` (`idGrade`),
  CONSTRAINT `idSubjectGS` FOREIGN KEY (`idSubject`) REFERENCES `subject` (`idSubject`)
